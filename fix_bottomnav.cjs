...
export const BottomNav: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 h-16 sm:h-18 md:h-screen md:w-24 lg:w-64 md:top-0 md:border-t-0 md:border-r bg-white/95 backdrop-blur-md border-t border-slate-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] md:shadow-none flex items-center justify-around md:flex-col md:justify-start md:py-8 px-2 sm:px-12 md:px-0">
...
fs.writeFileSync('src/components/BottomNav.tsx', replacement);
console.log('BottomNav.tsx updated');
